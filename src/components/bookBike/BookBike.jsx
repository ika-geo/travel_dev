...
require("./bookBike.css");
const BookBike = () => {
    return (<div className="bookBike coloredBG">
                        ...
                        <form>
                            <div className="inputs grid2">
                                ...
                                <div>
                                    ...
                                    <input required={true} id="Date" name="date" type="text" placeholder="Select date" onFocus={(e) => e.target.type = "date"} onBlur={(e) => e.target.type = "text"}/>
                                </div>
